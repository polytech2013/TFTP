...
public class TFTPClient
{
    ...
    // Private get methods
    /*
     * Returns the ammount of received byte data stored in the dataLength field.
     */
     ...
     * to the tftpSendPacket byte array.  Returns true if successfull,
     * false if not.
     */
